...
public:
   ...
   */
  void errorExit(std::string error_msg);
  ...
  void handleArpRequest(const arp_hdr* a_hdr, const Interface* iface);

  void handleArpReply(const arp_hdr* a_hdr, const Interface* iface);
